...
public class ShoppingCartController
{
    ...
    public ShoppingCart addProduct(Principal principal, @PathVariable("productId") int productId)
    {
        String userName = principal.getName();
        User user = userService.getByUserName(userName);
        int userId = user.getId();
    ...
    public ShoppingCart updateCart(@PathVariable int productId, @RequestBody ShoppingCartItem cartItem, Principal principal)
    {
        ...
        User user = userService.getByUserName(userName);
        int userId = user.getId();
        return shoppingCartService.updateProduct(userId,productId,cartItem.getQuantity());
    }
